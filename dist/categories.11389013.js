...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app/categories.js":[function(require,module,exports) {
// Container
var container = document.createElement('div'); // container.classList.add("container-xl", "px-5", "d-flex", "justify-content-center");
// main.appendChild(container);

document.body.appendChild(container); // Card 

var categoriesCard = document.createElement('div');
categoriesCard.setAttribute("id", "categories"); // categoriesCard.classList.add("my-5");

container.appendChild(categoriesCard); // Card Title
...
categoriesCard.appendChild(categoriesRow); // Form
...
label.appendChild(document.createTextNode("Nombre")); // label.classList.add("fs-6", "fw-bold", "mt-4");
...
formColSubmit.appendChild(formSubmit); // Table
...
categoriesTable.classList.add("mt-5"); // const createCategoryList = () => {
//     tableBody.innerHTML = "";
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/categories.js"], null)
//# sourceMappingURL=/categories.11389013.js.map